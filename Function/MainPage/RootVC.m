...
@property(nonatomic,strong)SimpleListView *simpleListView;
...
{
    if (_simpleListView == nil) {
        _simpleListView = [[SimpleListView alloc]initWithFrame:CGRectMake(SCREEN_W, 0, SCREEN_W, SCREEN_H - 64)];
    }
...
-(void)interfaceInital
{
    ...
    [self.scrollView addSubview:self.simpleListView];
